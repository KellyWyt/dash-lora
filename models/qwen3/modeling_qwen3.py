...
# from models.my_utils_new import GenerationMixin
...
class Qwen3Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        query_states = self.q_norm(self.q_proj(hidden_states, modality_masks).view(hidden_shape)).transpose(1, 2)
        key_states = self.k_norm(self.k_proj(hidden_states, modality_masks).view(hidden_shape)).transpose(1, 2)
        value_states = self.v_proj(hidden_states, modality_masks).view(hidden_shape).transpose(1, 2)
...
class Qwen3Model(Qwen3PreTrainedModel):
    ...
    def forward(
        ...
        position_ids: Optional[torch.LongTensor] = None,
        past_key_values: Optional[Cache] = None,
        inputs_embeds_all: Optional[torch.FloatTensor] = None,
...
class Qwen3ForCausalLM(Qwen3PreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(
        self,
        input_ids_all: torch.LongTensor,
        past_key_values: Optional[Cache] = None,
        ...
        **kwargs,
        ...
        if isinstance(input_ids_all, list):
            ...
            # print(f"[CHECK THIS] modality_maks type: {type(modality_masks)}")
            # print(f"[CHECK THIS] modality_maks length: {len(modality_masks)}")
        else:
