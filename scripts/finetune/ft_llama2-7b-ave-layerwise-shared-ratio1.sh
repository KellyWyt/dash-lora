...
RUN_NAME=llama2-7b-ave-layerwise-shared-countmatched-ratio1
OUTPUT_LOG=results/log/llama2/layerwise-shared-countmatched-ratio1.log
export CUDA_VISIBLE_DEVICES=0,1,2,3
export TOKENIZERS_PARALLELISM=true
mkdir -p "$(dirname "$OUTPUT_LOG")"

torchrun --nproc_per_node "$NPROC_PER_NODE" --master_port "$MASTER_PORT" \
    scripts/finetune/finetune_layerwise_shared.py \
    ...
    --reserved_modality None --exp_desc layerwise-shared-lora-ablation \
