...
RUN_NAME=qwen3-8B_avqa_dash-lora-r-4-alpha-16-ratio-1
OUTP_DIR=results
OUTPUT_LOG=results/log/qwen3/avqa/qwen3-8b-dash-lora-r-4-alpha-16-ratio-1-rank-sync-v1.log
