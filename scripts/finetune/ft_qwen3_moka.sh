...
qwen2_ckpt_path=pretrained_ckpts/Qwen3-8B
...
RUN_NAME=qwen3-8B_music_moka_r_4   # for base MokA

OUTP_DIR=results
# OUTPUT_LOG=results/log/finetune-share-qwen2-7b-moka_3.12_16_18.log
OUTPUT_LOG=results/log/qwen3/qwen3-8b-moka-r-4_3.26_20:15.log
...
torchrun --nproc_per_node $NPROC_PER_NODE \
    ...
    scripts/finetune/finetune_qwen3-moka.py \
