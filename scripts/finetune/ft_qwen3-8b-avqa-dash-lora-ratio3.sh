...
RUN_NAME=qwen3-8B_avqa_dash-lora-r-4-alpha-16-ratio-3
OUTPUT_LOG=results/log/qwen3/avqa/qwen3-8b-dash-lora-r-4-alpha-16-ratio-3.log
...
torchrun --nproc_per_node "$NPROC_PER_NODE" --master_port "$MASTER_PORT" \
    ...
    --llm_name qwen3-8b --reserved_modality None \
    --loratype dash-lora --loramethod train \
    --model_name_or_path "$qwen3_ckpt_path" \
    --exp_desc "dash-lora-ratio-3" \
