...
RUN_DIR="$PROJECT_DIR/results/finetune-llama-avqa/llama2-7b-avqa-dash-ablation-reverse_energy-ratio3"
CKPT_DIR="$RUN_DIR/checkpoint-1995"
TOPOLOGY_PATH="$RUN_DIR/dash_ablation_topology.json"
LOG_FILE="$CKPT_DIR/inference_avqa_dash_ablation_reverse_energy.log"
...
/nfs1/miniconda3/envs/moka/bin/torchrun \
    ...
    --seed 42 --mode test \
    --dash_ablation_mode reverse_energy \
