...
YOUR_CKPT_PATH=results/finetune-qwen3/qwen3-8B_avqa_dash-lora-r-4-alpha-16-ratio-1/checkpoint-2994
...
torchrun --nproc_per_node "$NPROC_PER_NODE" \
    ...
    --output_dir not_used >> "$YOUR_CKPT_PATH/inference_ave.log" 2>&1
