...
RUN_DIR=results/finetune-llama-ave/llama2-7b-ave-dash-crossmodal-strict-ratio1
OUTPUT_LOG=results/log/llama2/infer-dash-crossmodal-strict-ratio1.log
...
torchrun --nproc_per_node "$NPROC_PER_NODE" --master_port "$MASTER_PORT" \
    scripts/infer/inference_cut_multiGPU_dash_crossmodal_strict.py \
