...
from transformers.trainer import (TRAINER_STATE_NAME, get_parameter_names,
                                  has_length, is_sagemaker_mp_enabled, logger)
...
class UnifiedTrainer(Trainer):
    ...
    def _get_train_sampler(self, train_dataset: Optional[Dataset] = None) -> Optional[torch.utils.data.Sampler]:
        # print("[CHECK THIS] we are use new get_train_sampler")
