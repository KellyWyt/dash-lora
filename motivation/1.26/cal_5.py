...
def collect_layer_metrics(path, ratio_label):
    ...
    for key in state_dict.keys():
        ...
        if shared_b_key in key:
            ...
            # 只有当 Text 和 Video 的 A 矩阵都存在时，才能计算相似度
...
try:
    sns.boxplot(x='Ratio', y='Value', data=df, palette=['#ff9999','#66b3ff','#99ff99'], width=0.5, ax=ax)
...
ax.set_ylabel("Text-Video Cosine Similarity")
ax.set_xlabel("Ratio Settings")

save_path = "box_plot_analysis_fixed.png"
plt.tight_layout()
